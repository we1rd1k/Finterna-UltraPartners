...
import api.tests.models.HttpResponse
import api.tests.utils.deepCopy
import api.tests.utils.fromJson
...
private fun processRegexp(initialExpected: Any, actual: Any): Any {
    ...
    expected::class.memberProperties.map { prop ->
        ...
        if (prop.returnType.toString().startsWith("api.tests.models") &&
